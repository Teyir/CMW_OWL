 <!-- Page Tittle Start -->
		<section class="page-tittle page-tittle-lg bg dark-overlay" style="background-image: url(<?php echo $image_entete_page; ?>)">
			<div class="container">
				<div class="page-tittle-head">
					<h2>Confirmation de votre action de modération</h2>
				</div>
        ...
        <!-- Page Tittle End -->
<section class="section-1"><div class="container"><br/>
...
if(isset($_GET['choix']))
{
			...
			switch($choix)
			{
				...
				case '2':
					...
					<form action="<?php echo $_Serveur_['General']['url']; ?>?&action=forum_moderation&id_topic=<?php echo $id; ?>&choix=2&confirmation=true" method="post">
						...
						<div class="form-group row">
							<div class="col-sm-10">
								<button type="submit" class="btn btn-sm btn-theme">Supprimer ce topic :(</button>
							</div>
							<div class="col-sm-2">
					<a href="index.php" class="btn btn-sm btn-dark">Annuler</a>
				</div>
						</div>
					</form><?php
					}
				...
				case '3':
					...
					<form action="<?php echo $_Serveur_['General']['url']; ?>?&action=forum_moderation&id_topic=<?php echo $id; ?>&choix=3&confirmation=true" method="post">
						...
						<div class="form-group row">
							<div class="col-sm-10">
								<button type="submit" class="btn btn-sm btn-theme">Déplacer la discussion </button>
							</div>
							<div class="col-sm-2">
					<a href="index.php" class="btn btn-sm btn-dark">Annuler</a>
				</div>
	...
	if($choix == 4)
		{
			...
			<form action="?&action=signalement&confirmation=true" method="post">
				...
				<div class="row">
					<div class="col-sm-10">
						<button class="btn btn-sm btn-theme" type="submit">Signaler ! </button>
					</div>
					<div class="col-sm-2">
					<a href="index.php" class="btn btn-sm btn-dark">Annuler</a>
				</div>
	...
	if($choix == 5)
	{
		...
		<form action="?&action=signalement_topic&confirmation=true" method="post">
			...
			<div class="form-group row">
				<div class="col-sm-10">
					<button type="submit" class="btn btn-sm btn-theme">Signaler ce topic !</button>
				</div>
				<div class="col-sm-2">
					<a href="index.php" class="btn btn-sm btn-dark">Annuler</a>
				</div>
...
?></div><br><br><br><br><br><br><br><br><br></section></div>