	...
	if($_Forum_->exist($id))
	{
		...
		if(($_Joueur_['rang'] == 1 OR $_PGrades_['PermsForum']['general']['addSousForum'] == true) AND !$_SESSION['mode'] && !isset($id_sous_forum))
		{
			...
			<div class="col-md-offset-8 col-md-4">
				<a class="btn btn-md btn-theme" role="button" data-toggle="collapse" href="#sous_cat" aria-expanded="false" aria-controls="collapseExample">
				  Créez un sous-forum
				</a>
			</div>
		...
		<form action="?&action=create_topic" method="post">
			...
			<div class="form-group row">
				<center><div class="col-sm-offset-2 col-sm-10">
					<button type="submit" class="btn btn-md btn-theme">Poster</button>
				</div></center>
			</div>
		</form>
		<?php 
